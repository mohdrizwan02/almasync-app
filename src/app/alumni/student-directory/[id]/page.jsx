...
const mockStudentProfile = {
  ...
  about:
    "Passionate computer science student with a keen interest in web development and artificial intelligence. Looking for opportunities to apply my skills in real-world projects and collaborate with industry professionals.",
  profileHeadline: "Computer Science Student | Web Developer | AI Enthusiast",
  gender: "female",
  skills: [
    "JavaScript",
    "React",
  ...
  education: [
    {
      educationInstitution: "University of Technology",
      educationDegree: "Bachelor of Technology",
      educationFieldOfStudy: "Computer Science",
      educationStartYear: 2020,
      educationEndYear: 2024,
      educationGrade: "3.8/4.0",
      educationDescription:
        "Focused on software development and artificial intelligence. Participated in various hackathons and coding competitions.",
    ...
    {
      educationInstitution: "City High School",
      educationDegree: "High School Diploma",
      educationFieldOfStudy: "Science",
      educationStartYear: 2018,
      educationEndYear: 2020,
      educationGrade: "95%",
      educationDescription:
        "Graduated with honors. Active member of the computer science club.",
      educationAssociatedSkills: [
        "Basic Programming",
        "Mathematics",
        "Physics",
  ...
  internships: [
    {
      internshipCompany: "Tech Innovations Inc.",
      internshipRole: "Frontend Developer Intern",
      internshipLocation: "San Francisco, CA",
      currentlyWorking: false,
      internshipType: "Summer Internship",
      internshipStartDate: new Date("2022-05-01"),
      internshipEndDate: new Date("2022-08-31"),
      internshipDescription:
        "Developed and maintained frontend components using React. Collaborated with the design team to implement responsive UI designs. Participated in code reviews and agile development processes.",
    },
    {
      internshipCompany: "Data Analytics Co.",
      internshipRole: "Data Science Intern",
      internshipLocation: "Remote",
      currentlyWorking: true,
      internshipType: "Part-time",
      internshipStartDate: new Date("2023-01-15"),
      internshipEndDate: null,
      internshipDescription:
        "Working on data analysis and visualization projects. Building machine learning models for predictive analytics. Creating dashboards to present insights from data.",
    },
  ],
  mentorshipsNeeds: [
    "Career Guidance",
  ...
  certifications: [
    {
      ...
      certificationIssueDate: new Date("2022-03-15"),
      certificationExpirationDate: new Date("2025-03-15"),
      certificationId: "REACT-123456",
      certificationUrl: "https://example.com/cert1",
      certificationAssociatedSkills: ["React", "JavaScript", "Redux"],
    },
    {
      certificationName: "Machine Learning Specialization",
      certificationOrganization: "Stanford Online",
      certificationIssueDate: new Date("2022-08-10"),
      certificationExpirationDate: null,
      certificationId: "ML-789012",
      certificationUrl: "https://example.com/cert2",
  ...
  hobbies: ["Reading", "Hiking", "Photography", "Coding", "Chess"],
};
