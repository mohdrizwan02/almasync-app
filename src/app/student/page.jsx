  ...
  return (
    <>
      ...
      >
        ...
        >
          <Label className={"md:text-3xl lg:text-5xl"}>Empower Your Professional Journey</Label>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, delay: 0.2 }}
        >
          <Label className={"text-2xl text-center"}>Discover Features and Resouces on this Platform</Label>
        </motion.div>
      ...
      >
         <motion.div
          ...
          transition={{ duration: 0.5, delay: 0.2 }}
        >
          <Label className={"md:text-3xl lg:text-5xl"}> Latest Internship Opportunities</Label>
          <Label className={"text-center text-gray-700"}>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, delay: 0.2 }}
        >
          <Label className={"text-2xl text-center"}>Explore exciting internship opportunities</Label>
        </motion.div>
        ...
        <motion.button
          className="flex items-center gap-2 justify-center px-8 py-3 bg-orange-500 text-white rounded-full font-medium"
          whileHover="hover"
          whileTap="tap"
      ...
      >
         <motion.div
          ...
          transition={{ duration: 0.5, delay: 0.2 }}
        >
          <Label className={"md:text-3xl lg:text-5xl"}>Latest Job Opportunities</Label>
          <Label className={"text-center text-gray-700"}>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, delay: 0.2 }}
        >
          <Label className={"text-2xl"}> Explore exciting job opportunities</Label>
        </motion.div>
      ...
      >
         <motion.div
          ...
          transition={{ duration: 0.5, delay: 0.2 }}
        >
          <Label className={"md:text-3xl lg:text-5xl"}>Explore Our Alumni Network</Label>
          <Label className={"text-center text-gray-700"}>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, delay: 0.2 }}
        >
          <Label className={"text-2xl text-center"}>Explore Alumni Network</Label>
        </motion.div>
      ...
      >
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, delay: 0.2 }}
        >
          <Label className={"text-2xl text-center"}>Explore Upcoming Events</Label>
        </motion.div>
        <motion.div
          className="w-full max-w-screen-xl overflow-hidden"
          initial={{ x: -50, opacity: 0 }}
