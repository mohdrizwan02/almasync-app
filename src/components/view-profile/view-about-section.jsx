...
import { Globe, MapPin, Languages, Heart } from "lucide-react"

export default function ViewAboutSection({ profile }) {
  return (
    <motion.div
    ...
    >
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {profile.about && profile.about.length > 0 ? (
            profile.about.map((paragraph, index) => <p key={index}>{paragraph}</p>)
          ) : (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Languages and things they enjoy</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {profile.communicationLanguages && profile.communicationLanguages.length > 0 ? (
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            ...
            {!profile.socials?.linkedin &&
              ...
              !profile.socials?.twitter &&
              !profile.socials?.portfolio && (
                <p className="text-muted-foreground col-span-full">No social links provided</p>
              )}
          </div>
        </CardContent>
      </Card>
