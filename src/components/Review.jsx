...
const Review = () => {
  const ratings = [
    { stars: 5, percentage: 30, total: 30 },
    { stars: 4, percentage: 40, total: 40 },
    { stars: 3, percentage: 20, total: 20 },
    { stars: 2, percentage: 10, total: 10 },
    { stars: 1, percentage: 5, total: 5 },
  ];
              ...
              <form>
                <div className="flex relative">
                  ...
                  <input
                    ...
                    readOnly
                    className="block w-60 h-11 pr-10 pl-20 py-2.5 text-lg leading-8 font-medium rounded-full cursor-pointer shadow-xs text-black bg-transparent placeholder-black focus:outline-gray-200"
                  ...
                  {isOpen && (
                    <div
                      id="dropdown"
                      className="absolute top-12 right-0 z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44"
                    >
                      <ul className="py-2 text-sm text-gray-700">
                        {["Most Relevant", "Last Week", "Oldest"].map(
                          (option, index) => (
                            <li key={index}>
                              <button
